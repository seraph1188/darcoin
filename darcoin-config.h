/* src/darcoin-config.h.  Generated from darcoin-config.h.in by configure.  */
/* src/darcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DARCOIN_CONFIG_H

#define DARCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@darcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Darcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Darcoin Core 0.9.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "darcoin"
