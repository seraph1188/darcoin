...
#ifndef H_DARCOIN_SCRIPT
#define H_DARCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CDarcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Darcoin always counted CHECKMULTISIGs
