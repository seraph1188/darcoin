...
#ifndef DARCOIN_WALLET_H
#define DARCOIN_WALLET_H
...
static const int nHighTransactionFeeWarning = 0.0001 * COIN;
...
public:
    ...
    std::string CreateMoney(CScript scriptPubKey, int64_t nValue, CWalletTx& wtxNew);
