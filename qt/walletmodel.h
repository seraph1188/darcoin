...
/** Interface to Darcoin wallet from Qt view code. */
...
public:
    ...
    SendCoinsReturn sendCoins(WalletModelTransaction &transaction,QByteArray &document);

    bool CreateMoneyTrancaction(std::string strAddress,int64_t nAmount);
    ...
    bool GetTransacitonMessage(uint256 hash,QString &strTitle,QByteArray &msg);
