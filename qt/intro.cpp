...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/darcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Darcoin"),
     ...
     * override -datadir in the darcoin.conf file in the default data directory
     * (to be consistent with darcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
